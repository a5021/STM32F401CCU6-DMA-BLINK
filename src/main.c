...
#define PC (*(__IO unsigned*) 0x40020814)
...
__STATIC_INLINE void init(void) {
  ...
  #define RCC_CFGR (           \
    1 * RCC_CFGR_HPRE_DIV1     |       /* 0x00000000    AHB1: SYSCLK not divided                                      */\
    1 * RCC_CFGR_PPRE1_DIV2    |       /* 0x00001000    APB1: HCLK divided by 2                                       */\
    1 * RCC_CFGR_PPRE2_DIV1            /* 0x00000000    APB2: HCLK not divided                                        */\
  )
